...
local vue_plugin_location = '/Users/sergio/.local/share/nvim/mason/packages/vue-language-server/node_modules/@vue/language-server'
if vim.fn.isdirectory(vue_plugin_location) == 0 then
  vue_plugin_location = '/Users/sergio/Library/Application Support/Herd/config/nvm/versions/node/v22.22.3/lib/node_modules/@vue/language-server'
end
...
return {
  ...
  root_dir = function(bufnr, on_dir)
    ...
    -- manager lock file.
    local root_markers = { 'jsconfig.json','package-lock.json', 'yarn.lock', 'pnpm-lock.yaml', 'bun.lockb', 'bun.lock' }
